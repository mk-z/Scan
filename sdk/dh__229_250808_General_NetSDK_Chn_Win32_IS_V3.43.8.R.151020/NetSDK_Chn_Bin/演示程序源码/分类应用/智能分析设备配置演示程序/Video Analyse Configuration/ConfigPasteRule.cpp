// ConfigPasteRule.cpp : implementation file
//
...
CConfigPasteRule::CConfigPasteRule(CWnd* pParent /*=NULL*/)
	: CDialog(CConfigPasteRule::IDD, pParent)
{
	//{{AFX_DATA_INIT(CConfigPasteRule)
	m_strRuleName = _T("");
	m_bEnable = FALSE;
...
void CConfigPasteRule::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CConfigPasteRule)
...
BEGIN_MESSAGE_MAP(CConfigPasteRule, CDialog)
	//{{AFX_MSG_MAP(CConfigPasteRule)
	ON_BN_CLICKED(IDC_BUTTON_SET_RULELINES_TG, OnBtnSetRulelinesTg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CConfigPasteRule message handlers



void CConfigPasteRule::GetRuleInfo(CConfigRules* pParentWnd, long lLoginId, 
...
void CConfigPasteRule::ShowRuleInfo()
{
...
void CConfigPasteRule::UpdateFalse()
{
	UpdateData(FALSE);
}

void CConfigPasteRule::OnOK() 
{
...
void CConfigPasteRule::OnCancel() 
{
...
CFG_PASTE_INFO* CConfigPasteRule::SaveRuleInfo()
{
...
BOOL CConfigPasteRule::RulenameIsExit()
{
...
void CConfigPasteRule::OnBtnSetRulelinesTg() 
{
	...
	pSceneShowDlg->Init(isDrawRules,EVENT_IVS_PASTEDETECTION, m_lLoginId, m_nCurrentChannel, this);
...
void CConfigPasteRule::SaveLinesInfo(CSceneShow* pSceneShowDlg) 
{
	int i;
...
void CConfigPasteRule::InputEventRulesInPic(CPictrueDialog* pPicShow, float fProportionX, float fProportionY)
{
...
BOOL CConfigPasteRule::OnInitDialog() 
{
